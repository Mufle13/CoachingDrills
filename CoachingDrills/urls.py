...
from blog.views import admin_index, signup, profile, exercise_add, logout_view, exercices_listing, tags_listing, categories_listing, category_add, tag_add, exercise_delete, category_delete, tag_delete, exercise_detail, category_detail, tag_detail, exercise_edit, tag_edit, category_edit, index, exercise_builder, font_exercises_listing
...
urlpatterns = [
   ...
   path('exercises', font_exercises_listing, name='font_exercises_listing')
